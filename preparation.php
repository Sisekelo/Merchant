...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item middle" id="four"><a href="preparation.php" class="main current"><span class="outer"><span class="inner media_library">Preparations</span></span></a></li> 
					...
					while($row = mysqli_fetch_array($result))
						{
							...
							echo '<td><div align="center"><a  href="confirmPrepare.php?id='.$row['Id'].'&number='.$row['Buyer_Number'].'&vendor='.$Vendor.'" title="Click To View Orders">Confirm Prepared</a></div></td>';
