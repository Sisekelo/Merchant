...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item last" id="eight"><a href="deliveriesboom.php" class="main current"><span class="outer"><span class="inner settings">Deliveries</span></span></a></li>        
    </ul>
</div>
<!-- MENU END -->
</div>
		...
		<div class="portlet">
			...
			<table cellpadding="1" cellspacing="1" id="resultTable">
				...
				<?php
					...
					$result = $mysqli ->query("SELECT * FROM  Orders2 WHERE Confirm = '1' AND Prepared = '1' AND Deny='0'AND  PickUp = '1' AND Deliver='0'  ORDER BY Date ASC");
					while($row = mysqli_fetch_array($result))
						{
							...
							echo '<td><div align="center"><a href="confirmDeliveryboom.php?id='.$row['Id'].'&number='.$row['Buyer_Number'].'&vendor='.$Vendor.'" title="Click To View Orders">Confirm Delivery</a></div></td>';
