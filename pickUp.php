...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item middle" id="eight"><a href="pickUp.php" class="main current"><span class="outer"><span class="inner users">Pick Ups</span></span></a></li>  
					...
					while($row = mysqli_fetch_array($result))
						{
							...
							echo '<td><div align="center"><a href="confirmPickUp.php?id='.$row['Id'].'&number='.$row['Buyer_Number'].'&vendor='.$Vendor.'" title="Click To View Orders">Confirm Pick up</a></div></td>';
