...
<div id="menu">
	<ul class="group" id="menu_group_main">
		<li class="item first" id="one"><a href="boomgate.php?vendor=BoomGate" class="main "><span class="outer"><span class="inner dashboard">Confirmations</span></span></a></li>
		<li class="item middle" id="four"><a href="preparationboom.php" class="main current"><span class="outer"><span class="inner media_library">Preparations</span></span></a></li> 
		...
		<div class="portlet">
			...
			<table cellpadding="1" cellspacing="1" id="resultTable">
				...
				<?php
					...
					$result = $mysqli ->query("SELECT * FROM  Orders2 WHERE Confirm = '1' AND Prepared = '0' AND Deny='0'AND  PickUp = '0' AND Deliver='0' ORDER BY Date ASC");
					while($row = mysqli_fetch_array($result))
						{
							...
							echo '<td><div align="center"><a  href="confirmPrepareboom.php?id='.$row['Id'].'&number='.$row['Buyer_Number'].'&vendor='.$Vendor.'" title="Click To View Orders">Confirm Prepared</a></div></td>';
